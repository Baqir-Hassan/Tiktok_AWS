...
class Settings(BaseSettings):
    ...
    tts_provider_default: str = Field(default="edge", alias="TTS_PROVIDER_DEFAULT")
    ...
    ffmpeg_threads: int = Field(default=5, alias="FFMPEG_THREADS")
    ...
    render_video_bitrate: str | None = Field(default="3M", alias="RENDER_VIDEO_BITRATE")
    render_video_maxrate: str | None = Field(default="5M", alias="RENDER_VIDEO_MAXRATE")
    render_video_bufsize: str | None = Field(default="8M", alias="RENDER_VIDEO_BUFSIZE")
